...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    {
      ...
      subItems: [
        { name: "Overview", path: "/" },
        { name: "Operations Dashboard", path: "/dashboard" },
      ],
    },
    {
    ...
    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.25 5.25C8.25 3.73122 9.48122 2.5 11 2.5H13C14.5188 2.5 15.75 3.73122 15.75 5.25V6.75H8.25V5.25ZM6.75 6.75V5.25C6.75 2.90279 8.65279 1 11 1H13C15.3472 1 17.25 2.90279 17.25 5.25V6.75H18.5C19.7426 6.75 20.75 7.75736 20.75 9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9C3.25 7.75736 4.25736 6.75 5.5 6.75H6.75ZM4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25H18.5C18.9142 8.25 19.25 8.58579 19.25 9V19C19.25 19.4142 18.9142 19.75 18.5 19.75H5.5C5.08579 19.75 4.75 19.4142 4.75 19V9Z" fill="currentColor"></path></svg>`,
      name: "Procurement",
      subItems: [
        { name: 'Dashboard', path: '/procurement' },
        { name: 'Procurement Requests', path: '/procurement/requests' },
        { name: 'Tender Management', path: '/procurement/tenders' },
        { name: 'Published Tenders', path: '/procurement/published-tenders' },
        { name: 'Supplier Applications', path: '/procurement/applications' },
        { name: 'Deliveries', path: '/procurement/deliveries' },
      ],
    },
    {
      name: "Operations",
      ...
      subItems: [
        ...
        { name: "Menus", path: "/menus", pro: false },
  ...
  private updateNavItemsForRole() {
    const role = this.currentRole;
    this.navItems = [
      {
        icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V8.99998C3.25 10.2426 4.25736 11.25 5.5 11.25H9C10.2426 11.25 11.25 10.2426 11.25 8.99998V5.5C11.25 4.25736 10.2426 3.25 9 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H9C9.41421 4.75 9.75 5.08579 9.75 5.5V8.99998C9.75 9.41419 9.41421 9.74998 9 9.74998H5.5C5.08579 9.74998 4.75 9.41419 4.75 8.99998V5.5ZM5.5 12.75C4.25736 12.75 3.25 13.7574 3.25 15V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H9C10.2426 20.75 11.25 19.7427 11.25 18.5V15C11.25 13.7574 10.2426 12.75 9 12.75H5.5ZM4.75 15C4.75 14.5858 5.08579 14.25 5.5 14.25H9C9.41421 14.25 9.75 14.5858 9.75 15V18.5C9.75 18.9142 9.41421 19.25 9 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V15ZM12.75 5.5C12.75 4.25736 13.7574 3.25 15 3.25H18.5C19.7426 3.25 20.75 4.25736 20.75 5.5V8.99998C20.75 10.2426 19.7426 11.25 18.5 11.25H15C13.7574 11.25 12.75 10.2426 12.75 8.99998V5.5ZM15 4.75C14.5858 4.75 14.25 5.08579 14.25 5.5V8.99998C14.25 9.41419 14.5858 9.74998 15 9.74998H18.5C18.9142 9.74998 19.25 9.41419 19.25 8.99998V5.5C19.25 5.08579 18.9142 4.75 18.5 4.75H15ZM15 12.75C13.7574 12.75 12.75 13.7574 12.75 15V18.5C12.75 19.7426 13.7574 20.75 15 20.75H18.5C19.7426 20.75 20.75 19.7427 20.75 18.5V15C20.75 13.7574 19.7426 12.75 18.5 12.75H15ZM14.25 15C14.25 14.5858 14.5858 14.25 15 14.25H18.5C18.9142 14.25 19.25 14.5858 19.25 15V18.5C19.25 18.9142 18.9142 19.25 18.5 19.25H15C14.5858 19.25 14.25 18.9142 14.25 18.5V15Z" fill="currentColor"></path></svg>`,
        name: 'Lucky Summer SDA Inventory System',
        subItems: [
          { name: 'Overview', path: '/' },
          { name: 'Operations Dashboard', path: '/dashboard' },
        ],
    ...
    if (role === 'admin' || role === 'storekeeper' || role === 'stock-keeper') {
      this.navItems.push({
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z" fill="currentColor"></path></svg>`,
        name: 'Inventory',
        path: '/inventory',
    ...
    if (role === 'admin') {
      this.navItems.push({
        name: 'Admin',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path d="M12 2L14.4 8.2H21L15.8 12L18.2 18L12 14.2L5.8 18L8.2 12L3 8.2H9.6L12 2Z" fill="currentColor"></path></svg>`,
        subItems: [
